...
const Declaracao = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://suporteinspira.com.br/api/meuboleto/index.php/api/getlistaturmasdeclaracao?ra=${localStorage.getItem("@meuboleto/ra")}`)
      ...
      .then(result => { 
        ...
        seturlframe(`https://www.suporteinspira.com.br/integracao/backoffice/financeiro/boletoonline/index.php/declaracao?codcoligada=${localStorage.getItem("@meuboleto-app/coligada")}&codturma=${result.dados[0].CODTURMA}&codperlet=${result.dados[0].CODPERLET}&ra=${localStorage.getItem("@meuboleto/ra")}`)
      })
  ...
  function onChange(ev) {
    ...
    seturlframe(`https://www.suporteinspira.com.br/integracao/backoffice/financeiro/boletoonline/index.php/declaracao?codcoligada=${localStorage.getItem("@meuboleto-app/coligada")}&codturma=${resultado[0]}&codperlet=${resultado[1]}&ra=${localStorage.getItem("@meuboleto/ra")}`)
  }
